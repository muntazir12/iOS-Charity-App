...
class HajDetailViewController: UIViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        let request = NSMutableURLRequest(URL: NSURL(string: "http://52.89.129.22/android_login_api/api/get_haj_ios.php")!)
    ...
    @IBAction func previousButtonTapped(sender: AnyObject) {
        ...
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let viewController = storyboard.instantiateViewControllerWithIdentifier("previousHaj") as! previousHajViewController
